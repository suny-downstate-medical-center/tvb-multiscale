...
class DefaultExcIOInhIBuilder(NetpyneNetworkBuilder):
    ...
    def configure(self):
        super(DefaultExcIOInhIBuilder, self).configure() # TODO: clean-up
    ...
    def tvb_weight_fun(self, source_node, target_node, scale=None, sigma=0.1):
        if scale is None:
            scale = 10 * self.global_coupling_scaling #TODO: this is not proper scaling. dehardcode this 10 (see tvb_to_netpyne_weight_scaling)
